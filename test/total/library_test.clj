...
(def br2 {::dom/name "Borrower2" ::dom/max-books 2})
(def br3 {::dom/name "Borrower3" ::dom/max-books 3})

(def brs1 (list br1 br2))
(def brs2 (list br2 br1 br3))

(def bk1 {::dom/title "Title1", ::dom/author "Author1", ::dom/maybe-borrower br1})
(def bk2 {::dom/title "Title2", ::dom/author "Author2", ::dom/maybe-borrower nil})
(def bk3 {::dom/title "Title3", ::dom/author "Author3", ::dom/maybe-borrower br3})
(def bk4 {::dom/title "Title4", ::dom/author "Author4", ::dom/maybe-borrower br3})

(def bks1 (list bk2 bk1))
(def bks2 (list bk1 bk2 bk3))
(def bks3 (list bk1 bk2 bk3 bk4))
(def bks4 (list bk2 {::dom/title "Title1", ::dom/author "Author1", ::dom/maybe-borrower nil}))
